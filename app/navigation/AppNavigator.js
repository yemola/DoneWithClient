...
const AppNavigator = () => {
  ...
  useEffect(() => {
    ...
    Sentry.Native.captureException("token", token);

    Notifications.addPushTokenListener((notification) =>
      Sentry.Native.captureException("note: ", notification)
    );
  ...
  async function registerForPushNotificationsAsync() {
    ...
    if (Device.isDevice) {
      ...
      Sentry.Native.captureException("Error getting a push token", error);
    }
  }
